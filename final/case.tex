...
\begin{figure}
	\subfigure[Building power consumption at time $t$ predicted at time $t$ is denoted by $P(t)$, predicted 10 steps ahead at time $t-10$ is denoted by $P(t+10)$, and predicted 20 steps ahead at time $t-20$ is denoted by $P(t+20)$]{
		\centering
