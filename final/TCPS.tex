...
% Title portion
\title{Predictive Control with Regression Trees: An Application to Building Energy Management}
\author{ACHIN JAIN
...
\acmformat{Achin Jain, Francesco Smarra, Madhur Behl and Rahul Mangharam, 2016. Data Predictive Control for Cyber-Physical Energy Systems.}
...
Department of Computer Science, University of Virginia; F. Smarra, 
Department of Information Engineering, Computer Science and Mathematics, Universit\`{a} degli Studi dell'Aquila.}
\end{bottomstuff}
...
\label{sec:drtree}
\input{DRsynthesis.tex}

\section{DPCRT: Data-based Predictive Control using Regression Trees}
